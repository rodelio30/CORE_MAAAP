        ...
        function (require, module, exports) {
          (function (global, factory) {
            ...
            Autoplay.prototype.controls = function () {
              var _this = this;
              var _html =
                '<button aria-label="Toggle autoplay" class="lg-autoplay-button lg-icon"></button>';
        ...
        function (require, module, exports) {
          (function (global, factory) {
            ...
            Share.prototype.init = function () {
              var _this = this;
              var shareHtml =
                '<button aria-label="Share" aria-haspopup="true" aria-expanded="false" id="lg-share" class="lg-icon">' +
        ...
        function (require, module, exports) {
          (function (global, factory) {
            ...
            Rotate.prototype.buildTemplates = function () {
              ...
              this.core.outer
                .querySelector(".lg-toolbar")
                .insertAdjacentHTML("beforeend", rotateIcons);
            };
            ...
            Rotate.prototype.init = function () {
              ...
              utils.on(
                _this.core.outer.querySelector(".lg-rotate-left"),
                "click.lg",
                this.rotateLeft.bind(this)
              );
              utils.on(
                _this.core.outer.querySelector(".lg-rotate-right"),
                "click.lg",
                this.rotateRight.bind(this)
              );
              utils.on(
                _this.core.outer.querySelector(".lg-flip-hor"),
                "click.lg",
                this.flipHorizontal.bind(this)
              );
              utils.on(
                _this.core.outer.querySelector(".lg-flip-ver"),
                "click.lg",
                this.flipVertical.bind(this)
              );

              // Reset rotate on slide change
              utils.on(
                _this.core.el,
                "onBeforeSlide.lgtmrotate",
                function (event) {
            ...
            Rotate.prototype.applyStyles = function () {
              var image =
                this.core.___slide[this.core.index].querySelector(
                  ".lg-img-rotate"
                );
              utils.setVendor(
                image,
