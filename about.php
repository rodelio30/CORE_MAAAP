        ...
        <div class="row gy-5">
          ...
          <?php if ($core_guide): ?>
              <div class="core-guide-section ">
                  ...
                  <p><?php echo nl2br(htmlspecialchars($core_guide['about_description'])); ?></p>
              </div>
          <?php else: ?>
                ...
                <?php if (!in_array($section['about_title'], ['CORE Guide', 'Core Values', 'Vision', 'Mission'])): ?>
                    <div class="col-md-6">
                      ...
                      <i class="<?php echo $section['about_icon']; ?>"></i>
                        ...
                        <p><?php echo nl2br(htmlspecialchars($section['about_description'])); ?></p>
                      </div>
                      </div>
                    </div>
                <?php endif; ?>
          ...
          <div class="col-xl-3">
            ...
            <?php foreach ($about_sections as $section): ?>
              ...
              <div class="col-md-12">
                <div class="icon-box">
                  <h3><?php echo htmlspecialchars($section['about_title']); ?></h3>
                        <p><?php echo $section['about_description']; ?></p>
                </div>
              </div> 
                <?php endif; ?>
            <?php endforeach; ?>
                ...
                <div class="icon-box">
                    ...
                    <?php foreach ($core_values as $value): ?>
                        <div class="card p-2 mb-2">
                            ...
                            <p><?php echo nl2br(htmlspecialchars($value['core_description'])); ?></p>
                        </div>
                    <?php endforeach; ?>
                </div>
              </div> 
