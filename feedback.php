...
<body class="index-page">
  ...
  <main class="main">
    ...
    <!-- Feedback Section -->
    <!-- <section id="feedback" class="contact section" style="background-color: #f5f5f5;"> -->
      ...
      <div class="container">
        ...
        <div class="row gy-4">
          ...
          <div class="col-md-6">
              ...
              <form action="feedback.php" method="POST" class="php-email-form" style="background-color: #f5f5f5;">
