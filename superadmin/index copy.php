...
<section id="about" class="about section light-background" style="display: none;">
 ...
 <!-- Chat pop-up window -->
   ...
   <div class="chat-popup" id="chatPopup">
        ...
        <div class="chat-body">
            <p>This is a Navita chat window. Check out the questions and answers below:</p>

            <!-- Bootstrap Accordion for Dynamic Questions and Answers -->
            <div class="accordion mt-3" id="navitaAccordion">
                <?php
                if ($result->num_rows > 0) {
                    // Output each question and answer in a Bootstrap accordion format
                    $index = 0;
                    while($row = $result->fetch_assoc()) {
                        ...
                        <div class="accordion-item">
                            ...
                            <div id="collapse' . $index . '" class="accordion-collapse collapse" aria-labelledby="heading' . $index . '" data-bs-parent="#navitaAccordion">
            ...
            <!-- Bootstrap Accordion for Static Questions and Answers -->
            <div class="accordion mt-3" id="staticAccordion">
                <?php for ($i = 1; $i <= 10; $i++) { ?>
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="staticHeading<?php echo $i; ?>">
                            <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#staticCollapse<?php echo $i; ?>" aria-expanded="false" aria-controls="staticCollapse<?php echo $i; ?>">
                                Question <?php echo $i; ?>
                            </button>
                        </h2>
                        <div id="staticCollapse<?php echo $i; ?>" class="accordion-collapse collapse" aria-labelledby="staticHeading<?php echo $i; ?>" data-bs-parent="#staticAccordion">
                            <div class="accordion-body">
                                Answer <?php echo $i; ?>
                            </div>
                        </div>
        ...
        <div class="chat-footer">
            <p class="mb-1">Do you have a question?</p> 
            <form action="index.php" method="post">
              <div class="row">
                <div class="col-md-8">
                  <input type="text" class="form-control mb-2" name="question" placeholder="Type a message..." required>
                </div>
                <div class="col-md-4">
                  <button type="submit" name="submit_navita" class="btn btn-secondary">Submit</button>
                </div>
              </div>
            </form>
        </div>
